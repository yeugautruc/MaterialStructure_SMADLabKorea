...
%Load vector
findLy=find(node(:,2)==Ly*100); %find y at LY
findL0=find(node(:,2)==0); %find y at 0
num_findy0=size(findL0,1);
F(findLy)=thk*f*Lx/num_findy0;
F(findLy(1))=thk*f*Lx/num_findy0/2;
F(findLy(end))=thk*f*Lx/num_findy0/2;
F(findL0)=-thk*f*Lx/num_findy0;
F(findL0(1))=-thk*f*Lx/num_findy0/2;
F(findL0(end))=-thk*f*Lx/num_findy0/2;
